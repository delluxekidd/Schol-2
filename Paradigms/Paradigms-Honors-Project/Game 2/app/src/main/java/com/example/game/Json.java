package com.example.game;//Gavin Edens, 02/08/2023, Homework 3: map editor
// ----------------------------------------------------------------
...
public abstract class Json
{
	...
	public static Json load(Context c, String filename)
	{
		String contents;
		try
		{
			InputStream inputStream = c.getResources().openRawResource(R.raw.gamemap);
